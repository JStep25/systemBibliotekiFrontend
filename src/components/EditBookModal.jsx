  ...
  return (
    <div className="modal-backdrop" style={{
      ...
      <div className="modal" style={{
        ...
        <h2 style={{ marginTop: 0 }}>Edytuj dane książki</h2>
        ...
        <form onSubmit={handleUpdate} style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
          <div>
            <label style={{ display: "block", marginBottom: "5px", fontWeight: "600" }}>Tytuł</label>
            <input
          ...
          <div>
            <label style={{ display: "block", marginBottom: "5px", fontWeight: "600" }}>Autor</label>
            <input
              style={{ width: "100%", padding: "10px", borderRadius: "4px", border: "1px solid #ccc" }}
              value={autor}
